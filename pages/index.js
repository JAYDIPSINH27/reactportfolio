    ...
    <div>
      ...
      <main className=" bg-slate-50 px-10 ">
        <section className="min-h-screen">
          <nav className='py-5 mb-12 flex justify-between border-y-2'>
            <h1 className='text-xl font-burtons font-semibold hover:text-orange-500'><a href="/" >Jaydipsinh Padhiyar</a></h1>
          ...
          <div className='flex p-10 max-lg:flex-col'>
            <div>
            ...
            <div className="relative mt-10 mx-auto bg-gradient-to-b from-yellow-300 rounded-full w-64 h-64 max-lg:overflow-hidden">
              <Image src={d31} />
            </div>
